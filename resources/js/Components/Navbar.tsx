...
import { Link } from "../../../node_modules/@inertiajs/inertia-react/index";
import Logo from "../../js/assets/dlf-engage-light.png";
import FaqPdf from "../../js/assets/faqs.pdf"
            ...
            <div className="justify-between py-2 mx-auto lg:max-w-7xl md:items-center md:flex md:px-4">
                ...
                <div className="flex">
                    <div>
                        ...
                        >
                            <ul className="justify-end space-y-8 md:flex md:space-x-0 md:space-y-0">
                                <li className="text-white text-xs hover:text-custom_hover">
                                    <Link className="md:px-3 border-r-2 border-white uppercase" href={route("about.index")}>About</Link>
                                </li>
                                {/* <li className="text-white text-xs hover:text-custom_hover">
                                    <Link className="px-3 border-r-2 border-white uppercase" href="">Gallery</Link>
                                </li> */}
                                <li className="text-white text-xs hover:text-custom_hover">
                                    <Link className="md:pl-3 md:px-3 border-r-2 uppercase" href={route('contact.index')}>Contact</Link>
                                </li>
                                <li className="text-white text-xs hover:text-custom_hover">
                                    <a className="md:pl-3" href={FaqPdf} target="_blank" >FAQs</a>
                                </li>
                            </ul>
                        </div>
                        <div
